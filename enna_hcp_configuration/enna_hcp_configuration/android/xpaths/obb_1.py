...
INFO_TITLE = XpathString("//*[@text='Info'][contains(@resource-id, 'dashboard-INFO')]") #_todo
...
#MAIN_INFO_BUTTON = XpathString("//*[@class='android.widget.ListView']/.//*[@resource-id='dashboard-INFO']")
MAIN_INFO_BUTTON = XpathString("//*[@package='com.valtech_mobility.obb.audi]/./*[@class='android.view.View']/.//*[@resource-id='dashboard-INFO']")
