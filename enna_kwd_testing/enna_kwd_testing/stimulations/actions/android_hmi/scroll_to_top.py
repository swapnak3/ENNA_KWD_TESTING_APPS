...
class ScrollToTop(enna_kwd_testing.stimulations.base.keyword_stim_baseclass.KeywordStimulation):
	"""Class containing functionality scroll to top list."""
	...
	def _action(self) -> bool:
		...
		if not wrapper_android_hmi.wait_and_scroll_list_to_top(list_element, self.__android_hmi):
			self._reporting.add_report_message_system_error("Could not scroll to top.")
			return False

		self._reporting.add_report_message_pass("The List is scrolled to the top")
