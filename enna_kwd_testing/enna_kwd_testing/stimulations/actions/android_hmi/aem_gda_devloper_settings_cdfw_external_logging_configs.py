...
class SetAemGdaDevloperSettingsCdfwExternalLoggingConfigs(enna_kwd_testing.stimulations.base.keyword_stim_baseclass.KeywordStimulation):
	"""Class containing functionality to set external logging configs in aem gda."""
	...
	def _action(self) -> bool:
		...
		2. Scroll to 'read external logging configs' in list on screen
		3. Set switch to read external logging configs State "ON" or "OFF"
		...
		str__switch_xpath = self._xpaths.get_xpath("cdfw_and_speech", "toggle_read_external_log_configs")
		...
		MODULE_LOGGER.info(f"The read external logging config is set to '{str__toggle_button_state}' ")
