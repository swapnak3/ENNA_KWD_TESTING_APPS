...
class CheckVoiceGuidanceInNavigation(enna_kwd_testing.stimulations.base.keyword_stim_baseclass.KeywordStimulation):
	"""Class containing functionality to check voice guidance is set in navigation."""
