...
class CheckVoiceGuidanceDuringCalls(enna_kwd_testing.stimulations.base.keyword_stim_baseclass.KeywordStimulation):
	"""Class containing functionality to check the voice guidance during calls in navigation settings."""
	...
	def _action(self) -> bool:
		...
		2. Scroll to 'guidance during calls' button on screen
		...
		str_xpath__short_prompt_switch = self.__xpathloader.get_xpath_app_screen_id(reporting=self._reporting, android_hmi=self.__android_hmi, element="settingVoiceGuidanceSwitch")
