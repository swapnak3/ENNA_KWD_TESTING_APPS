...
Contains payload for RDT (Remote Departure Timer) Extended service
"""
import datetime
...
class Payload(interface.Payload):
    """ RDT (Remote Departure Timer) Extended payload """

    def __init__(self, **kwargs):
        """Initialize payload object for RDT Extended service.
        ...
        self.climatisation_position_front_left_state = interface.ClimatisationPositionState.TRUE.value
        self.climatisation_position_front_right_state = interface.ClimatisationPositionState.TRUE.value
        self.climatisation_position_rear_left_state = interface.ClimatisationPositionState.TRUE.value
        self.climatisation_position_rear_right_state = interface.ClimatisationPositionState.TRUE.value
        ...
        self.payload = f"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n" \
                       ...
                       f"xsi:schemaLocation=\"http://www.vw.com/mbb/departureTimersAndProfilesReportRequest ../../XSD_mbb/2017.1/XSD_RDT/departureTimersAndProfilesReportRequest_v1_0_3.xsd \">\r\n" \
                       f"\r\n" \
                       ...
                       f"\r\n" \
                       f"  <!-- Global Settings (erweiterte VoKo) - gueltig fuer alle Timer -->\r\n" \
                       f"  <departureTimersAndProfilesReportRequest:climatisationSettings\r\n" \
                       f"  remoteClima:climatisationDuration=\"0\"\r\n" \
                       ...
                       f"  remoteClima:windowHeatingFront=\"false\"\r\n" \
                       f"  remoteClima:windowHeatingRear=\"false\">\r\n" \
                       ...
                       f"            climatisationElementTypes:isEnabled=\"{self.climatisation_position_front_left_state}\" />\r\n" \
                       f"        <climatisationElementTypes:zoneSetting\r\n" \
                       f"            climatisationElementTypes:position=\"frontRight\"\r\n" \
                       f"            climatisationElementTypes:isEnabled=\"{self.climatisation_position_front_right_state}\" />\r\n" \
                       f"        <climatisationElementTypes:zoneSetting\r\n" \
                       f"            climatisationElementTypes:position=\"rearLeft\"\r\n" \
                       f"            climatisationElementTypes:isEnabled=\"{self.climatisation_position_rear_left_state}\" />\r\n" \
                       f"        <climatisationElementTypes:zoneSetting\r\n" \
                       f"            climatisationElementTypes:position=\"rearRight\"\r\n" \
                       f"            climatisationElementTypes:isEnabled=\"{self.climatisation_position_rear_right_state}\" />\r\n" \
                       f"      </climatisationElementTypes:zoneSettings>\r\n" \
                       f"    </remoteClima:climatisationElementSettings>\r\n" \
                       f"    <remoteClima:heaterMode>comfort</remoteClima:heaterMode>\r\n" \
                       f"    <remoteClima:heaterSource>electric</remoteClima:heaterSource>\r\n" \
