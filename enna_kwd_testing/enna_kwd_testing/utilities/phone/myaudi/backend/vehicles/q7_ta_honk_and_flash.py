...
Contains vehicle class for TA ODP Q7 Honk and Flash with VIN: "BAUSHS4MZ21032502"
"""
...
class TaOdpQ7HonkAndFlash(Vehicle):
	"""Interface for vehicle BAUSHS4MZ21032502.
	...
	def __init__(self):
		...
		self.vin = vin_database.Q7_HONK_AND_FLASH_VIN
		self.nickname = vin_database.Q7_HONK_AND_FLASH_NICKNAME
