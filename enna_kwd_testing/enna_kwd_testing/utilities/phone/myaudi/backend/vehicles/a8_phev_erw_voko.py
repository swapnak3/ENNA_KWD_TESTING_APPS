...
class A8PhevErwVoko(Vehicle):
	"""Interface for vehicle BAUSHSF8521032503.
	...
	def __init__(self):
		...
		self.vin = vin_database.A8_PHEV_ERW_VOKO_VIN
		self.nickname = vin_database.A8_PHEV_ERW_VOKO_NICKNAME
